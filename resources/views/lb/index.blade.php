    ...
    <div class="container d-flex align-items-center flex-column">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12 border border-3 rounded" style="width: 800px; height: 500px;">
                ...
                <p>Pilih Leaderboard</p>
                <div class="bg-light rounded d-flex justify-content-evenly" style="width: 90%; height:300px; margin-left: 5%;">
                    <a href="/lb1" class="mt-5 rounded" style="background-color: rgb(184, 183, 183); height: 180px;">
                        <img src="/asset/number/1.png" style="width: 130px; height: 130px;"><br><br>
                        <font color="black">Leaderboard 1</font>
                    </a>
                    <a href="/lb2" class="mt-5 rounded" style="background-color: rgb(184, 183, 183); height: 180px;">
                        <img src="/asset/number/2.png" style="width: 130px; height: 130px;"><br><br>
                        <font color="black">Leaderboard 2</font>
                    </a>
                    <a href="/lb3" class="mt-5 rounded" style="background-color: rgb(184, 183, 183); height: 180px;">
                        <img src="/asset/number/3.png" style="width: 130px; height: 130px;"><br><br>
                        <font color="black">Leaderboard 3</font>
                    </a>
                </div>
        </div>
    </div>
